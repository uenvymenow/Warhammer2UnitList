...
public class WildRiders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wild_riders);

        final ArrayList<UnitStats> woodElfList = new ArrayList<>();
        woodElfList.add(new UnitStats("Wild Riders", "Melee Cavalry", "60 - Large", "1100", "6660", "40", "70", "85", "34", "23", "42", "62", "N/A", "N/A", "N/A"));
