...
public class Wardancers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wardancers);

        final ArrayList<UnitStats> woodElfList = new ArrayList<>();
        woodElfList.add(new UnitStats("Wardancers", "Dual Sword Infantry", "100 - Small", "800", "6800", "15", "70", "46", "44", "34", "36 + Bonus vs Infantry", "24", "N/A", "N/A", "N/A"));
