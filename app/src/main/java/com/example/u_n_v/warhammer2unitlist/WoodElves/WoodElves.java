...
public class WoodElves extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Durthu"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Waystalker"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Spellsinger (Shadows)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Spellsinger (Beasts)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Spellsinger (Life)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Branchwraith"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Eternal Guard"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Dryads"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Eternal Guard (Shields)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Wardancers"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Wardancers (Asrai Spears)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Wildwood Rangers"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Glade Guard"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Glade Guard (Hagbane Tips)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Glade Guard (Starfire Shafts)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Deepwood Scouts"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Deepwood Scouts (Swiftshiver Shards)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Waywatchers"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Wild Riders"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Wild Riders (Shields)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Glade Riders"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Glade Riders (Hagbane Tips)"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Hawk Riders"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Sisters of the Thorn"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Great Eagle"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Tree Kin"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Treeman"));
        woodElfNames.add(new UnitName((R.drawable.wood_elves), (R.drawable.argwylon),"Forest Dragon"));
