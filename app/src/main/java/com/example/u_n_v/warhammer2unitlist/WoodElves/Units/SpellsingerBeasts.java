...
public class SpellsingerBeasts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spellsinger_beasts);

        final ArrayList<UnitStats> woodElfList = new ArrayList<>();
        woodElfList.add(new UnitStats("Spellsinger (Beasts)", "Wizard","1 - Small", "1286", "3420", "15", "60", "34", "33 + Magical Attacks", "34", "240", "19", "N/A", "N/A", "N/A"));
