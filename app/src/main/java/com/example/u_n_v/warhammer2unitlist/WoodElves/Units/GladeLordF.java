...
public class GladeLordF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glade_lord_f);

        final ArrayList<UnitStats> woodElfList = new ArrayList<>();
        woodElfList.add(new UnitStats("Glade Lord (F)", "Hybrid Weapon Specialist", "1 - Small", "1343", "3908", "50", "70", "46", "65", "60", "360", "30", "30 + Magical Attacks", "190", "389"));
