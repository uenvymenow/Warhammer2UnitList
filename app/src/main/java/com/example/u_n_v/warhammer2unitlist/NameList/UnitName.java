...
public class UnitName {
    ...
    // Class constructor
    public UnitName(int factionImage1, String unitName){
        mFactionImage1 = factionImage1;
        mUnitName = unitName;
    }

    // Class constructor
    public UnitName(int factionImage1, int factionImage2, String unitName){
        mFactionImage1 = factionImage1;
    ...
    // Class constructor
    public UnitName(int factionImage1, int factionImage2, int factionImage3, String unitName){
        mFactionImage1 = factionImage1;
        mFactionImage2 = factionImage2;
    ...
    // Class constructor
    public UnitName(int factionImage1, int factionImage2, int factionImage3, int factionImage4, String unitName){
        mFactionImage1 = factionImage1;
        mFactionImage2 = factionImage2;
        mFactionImage3 = factionImage3;
